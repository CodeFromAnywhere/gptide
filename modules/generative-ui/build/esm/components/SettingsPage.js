...
export var SettingsPage = function () {
    ...
    return (React.createElement(Div, { className: "max-lg:mx-4 lg:mx-20" }, hydrated && apiHydrated ? (React.createElement(FunctionForm, { tsFunction: SetConfigIndex, initialValues: [customUrl, config.disableAdmin], submitFunction: setConfig, withResult: function () {
