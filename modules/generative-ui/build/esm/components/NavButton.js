...
export var NavButton = function (props) {
    ...
    var className = " ".concat(isActive ? "dark:bg-blue-800" : "dark:bg-gray-700", " dark:hover:bg-gray-600 ").concat(isActive ? "bg-blue-300" : "bg-gray-100", " light:hover:bg-gray-200 rounded-md border border-black p-2 m-1 cursor-pointer lg:mx-2");
    if (onClick) {
