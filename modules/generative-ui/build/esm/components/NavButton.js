...
export var NavButton = function (props) {
    var href = props.href, title = props.title, onClick = props.onClick, isActive = props.isActive, openContextMenuProps = props.openContextMenuProps, id = props.id;
    var className = " ".concat(isActive ? "dark:bg-blue-800" : "dark:bg-gray-700", " dark:hover:bg-gray-600 ").concat(isActive ? "bg-blue-300" : "bg-gray-100", " light:hover:bg-gray-200 rounded-md border border-black p-2 my-1 mr-2 cursor-pointer lg:mr-4");
    if (onClick) {
